...
<p>session 영역 : <strong>${sessionScope.id }</strong></p>
<p>session 영역 : <strong>${id }</strong></p>

<p>application 영역 : <strong>${applicationScope.count }</strong></p>
<p>application 영역 : <strong>${count }</strong></p>
</body>
</html>